  ...
  return (
    <div className='mt-14'>
        {cartProducts.map((cartProduct) => (
            <div key={cartProduct?.id} className='flex sm:flex-row flex-col items-center justify-between sm:w-8/12 w-[90%] mx-auto shadow-lg p-5  rounded-lg mt-6'>
                <div>
                    ...
                    <h3 className='text-sm text-neutral-600 mb-2'>Style: {cartProduct?.size}</h3>
                    <h3 className='text-sm text-neutral-600 mb-2'>Store: {cartProduct?.color}</h3>
