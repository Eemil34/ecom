...
const ImageGallery = ({imageUrls}: Props) => {
  ...
  return (
    <div className='images  mr-10 grid mb-20 grid-cols-7'>
        ...
        <div className='selected-image col-span-5 border-2 border-slate-100   rounded-2xl bg-slate-50 h-[100%] lg:h-[90%]'>
            <img src={urlArray[selectedImage]} className='h-[full] w-auto object-cover object-top' alt="" />
        </div>
    </div>
  )
}
